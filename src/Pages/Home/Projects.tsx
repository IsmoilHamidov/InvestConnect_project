  ...
  return (
    <div className="relative min-h-[60rem] mt-8">
      ...
      <div className="flex flex-col justify-center items-center z-20 absolute top-[120px] left-1/2 transform -translate-x-1/2">
        ...
        <div className="flex justify-between items-center mt-20 w-[80rem]">
          {cardData.map((card) => (
            ...
            >
              ...
              <div
                className="absolute top-3 z-20 -right-5
              ...
              <div className="px-3 py-5 bg-white ">
                ...
                <div className="flex justify-between items-center mt-1 mb-2">
                  <p className="text-md text-custom-gray font-medium">
                    {card.description}
                  </p>
        ...
        <Link to="/products">
          <button className="Brown_button rounded-3xl p-3 px-12 text-base text-white bg-custom-gray mt-16 ">
            Bekijk ons aanbod
          </button>
        </Link>
      </div>
